...
void main() {
  test(
    ...
    () async {
      ...
      final outboxRepo = OutboxCheckoutRepository(inner: server, database: database);
      ...
      final outboxRepoRestarted = OutboxCheckoutRepository(inner: server, database: database);
